    ...
    protected function copyToBackupDestinations(Zip $zip)
    {
        $this->backupDestinations->each(function (BackupDestination $backupDestination) use ($zip) {
            ...
            try {
                ...
                echo "Copying {$fileName} (size: {$fileSize}) to disk named {$backupDestination->getDiskName()}...";
                ...
                echo "Successfully copied .zip file to disk named {$backupDestination->getDiskName()}.";
                ...
                echo "Copying .zip file failed because: {$exception->getMessage()}.";
